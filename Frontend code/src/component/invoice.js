...
export default function Invoice(props) {
  ...
  const { bdata, bname, bemail, bcity, bevent, bguest, bfood, bequipment, children, openPop, setOpenPop } = props

  // const {}
  const [dbPriceData, setDBPricedata] = useState([])
  const [udata, setUdata] = useState([])

  const fetchCurrent = async (data) => {
    axios.post(`${base_url}/currentbookings`, data).then(
      (response) => {
        swal
          .fire({
            icon: 'Success',
            ...
            <div className="container-fluid">
              <div className="row">
                <div className="text-right">
                  <button onClick={() => { setOpenPop(false) }} className="btn btn-danger ps-3 pe-3 mb-2 "> X </button>
                </div>
                  ...
                  <div className="col-md-12">
                    <div className="row">
                      ...
                      <div className="col-md-8 text-right">
                        ...
                        <p>Plot No. 6 & 7, Hardware Park,Hyderabad - 501510</p>
                        <p>+91-9822296812</p>
                          ...
                          <tr>
                            ...
                            <td>
                              <p> <strong><i className="fas fa-rupee-sign" area-hidden="true" />
                                {total} </strong> </p>
                              <p> <strong><i className="fas fa-rupee-sign" area-hidden="true" /> {discount} %
                              </strong> </p>
                              <p> <strong><i className="fas fa-rupee-sign" area-hidden="true" /> {toPay}
                              </strong> </p>
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td className="text-left text-primary">
                              <h4><strong><i className="fas fa-rupee-sign" area-hidden="true" /> {toPay}
                              </strong></h4>
                            </td>
                          </tr>
                        </tbody>
